    ...
    <i class="fa-solid fa-bars"></i>
          ...
          <div class="burger_menu">
            <div class="burger_menu_content">
                <nav class="navbar burger_menu_content_navbar" >
                    <ul class="navbar_ul  burger_menu_content_navbar_ul">
                        <li class="burger_menu_content_navbar_ul_li"><a href="index.html">მთავარი</a></li>
                        <li class="burger_menu_content_navbar_ul_li"><a href="market.html">მაღაზია</a></li>
                        <li class="burger_menu_content_navbar_ul_li"><a href="sales.html">ფასდაკლება</a></li>
                        <li class="burger_menu_content_navbar_ul_li"><a href="about.html">ჩვენს შესახებ</a></li>
                    </ul>
                </nav>
                <!--
                         =========================================================================================
                         NAVBAR  END
                          =========================================================================================
                      -->
                <ul class="userArea burger_menu_content_userArea">
                    <li class="LoginArea burger_menu_content_LoginArea">
                        <ul class="LoginAreaUl burger_menu_content_LoginAreaUl">
                            <li class="LoginAreaUl_ico burger_menu_content_LoginAreaUl_ico"></li>
                            <li class="LoginAreaUl_Content burger_menu_content_LoginAreaUl_Content">
            
                              <form  class="LoginAreaUl_Content_Form   burger_menu_content_LoginAreaUl_Content_Form" >
                                <div class="LoginAreaUl_Content_Form_Inputs  burger_menu_content_LoginAreaUl_Content_Form_Inputs">
